                              ...
                              <div>
                                <p className="-indent-0 text-justify text-base mt-6">
                                  <p className="text-wrap">
                                    1. Is artificial intelligence the ability of
                                    a digital computer or computer controlled
                                    robot to perform tasks commonly associated
                                    with intelligent beings? True/False
                                  </p>{" "}
                                  <p>
                                  ...
                                  <p>
                                    ...
                                    professionals in performing certain specific
                                    tasks? True/False
                                  </p>{" "}
                                  <p>
                                    {" "}
                                    5. Does artificial intelligence have
                                    applications in medical diagnosis, computer
