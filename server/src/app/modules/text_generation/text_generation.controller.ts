...
export const generateText = catchAsync(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    const prompt = `Give me {how_many_questions} questions in {difficulty} difficulty and {language} language in {format} format from the below text wrapped with """ : 
    ...
    The response will be like this below wrapped with """ : 
    """
